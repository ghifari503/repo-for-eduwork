  ...
  <div class="row">
    <div class="col-md-5 offset-md-3">
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" autocompelet="off" placeholder="Search from title" v-model="search">
      </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12" v-for="book in filteredList">
      <div class="info-box" v-on:click="editData(book)">
        <div class="info-box-content">
          ...
          <span class="info-box-number">Rp. @{{ numberWithTitik(book.price)}},- <small></small> </span>
        </div>
      </div>
    </div>
  </div>
