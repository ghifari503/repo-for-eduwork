...
<div id="controller">
    <div class="card">
        <div class="card-header">
            <a href="{{ url('transactions/create') }}"  class="btn btn-primary">+ transaction</a>
		...
		},
        {
            render: function(index, row, data, meta) {
                ...
                <div class="col">
                    ...
                    <a href="/transactions/${data.id}/edit" class="btn btn-info" onclick="controller.editData(event, ${meta.row})">
                        Edit
                    </a>
                    <a href="/transactions/${data.id}" class="btn btn-danger" onclick="controller.deleteData(event, ${data.id})">
                        Delete
                    </a>
            `
            },
