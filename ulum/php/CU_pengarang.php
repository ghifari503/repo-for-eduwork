...
<body>
    <div class="container">
        <a href="pengarang.php" class="btn btn-primary mt-2">Back to pengarang</a><br /><br />
        <!-- Update DATA -->
        <?php if (isset($_GET['id_pengarang'])) : ?>
            ...
            <form action="" method="POST">
                ...
                <table class="table table-borderless">
                    <tr>
                        <td width="20%">Nama Pengarang</td>
                        <td><input type="text" name="nama_pengarang" value="<?= $data['nama_pengarang'] ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td>Email</td>
        ...
        <?php else : ?>
            ...
            <form action="" method="POST">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td>Email</td>
                        <td><input type="email" name="email" class="form-control" class="form-control" /></td>
                    </tr>
                    <tr>
                        <td>No Telp.</td>
