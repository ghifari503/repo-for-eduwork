...
--
-- Host: localhost
-- Generation Time: Dec 01, 2021 at 12:56 PM
...
(22, 1234, 'Kapal pecah', 2014, 1, 1, 2, 200, 2000, NULL, NULL),
(24, 3451, 'Vue Js', 2021, 3, 6, 3, 15, 10000, NULL, NULL),
(26, 5454, 'PHP', 1995, 3, 3, 2, 200, 5000, '2021-12-01 03:04:45', NULL);
...
(10, 'Buku Sejarah Islam', '2021-12-01 05:44:52', '2021-12-01 05:54:22');
...
(4, 'Penerbit 044', 'penerbit44@gmail.com', '089720172091', 'Jakarta Selatann', NULL, '2021-12-01 04:52:35'),
(6, 'Penerbit 06', 'penerbit6@gmail.com', '08112187209', 'Jakarta Barat', NULL, NULL),
(9, 'Ulum', 'sahrululum73@gmail.com', '083813013523', 'Serang, banten', NULL, NULL),
(10, 'Sukii', 'suki1518000@gmail.com', '08383838380', 'Pamarayann', '2021-12-01 04:43:14', NULL);
...
(9, 'Pengarang 08', 'pengarang08@gmail.com', '014141234', 'adasdadadad', '2021-12-01 04:58:50', '2021-12-01 04:59:05');
...
--
ALTER TABLE `bukus`
  ADD CONSTRAINT `bukus_id_katalog_foreign` FOREIGN KEY (`id_katalog`) REFERENCES `katalogs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bukus_id_penerbit_foreign` FOREIGN KEY (`id_penerbit`) REFERENCES `penerbits` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `bukus_id_pengarang_foreign` FOREIGN KEY (`id_pengarang`) REFERENCES `pengarangs` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `detail_peminjaman`
--
ALTER TABLE `detail_peminjaman`
  ADD CONSTRAINT `detail_peminjaman_id_buku_foreign` FOREIGN KEY (`id_buku`) REFERENCES `bukus` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `detail_peminjaman_id_peminjaman_foreign` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjaman` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_id_anggota_foreign` FOREIGN KEY (`id_anggota`) REFERENCES `anggotas` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_id_anggota_foreign` FOREIGN KEY (`id_anggota`) REFERENCES `anggotas` (`id`) ON DELETE CASCADE;
COMMIT;
