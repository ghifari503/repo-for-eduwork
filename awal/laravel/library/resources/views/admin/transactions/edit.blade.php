    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header text-white bg-primary">
                ...
                <a href="{{ route('transactions.index') }}" class="btn btn-sm btn-secondary float-right"><i class="fas fa-backward"></i> Back</a>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="post">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_start" id="date_start" class="form-control @error('date_start') is-invalid @enderror" value="{{ old('date_start', $transaction->date_start->format('Y-m-d')) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_end" id="date_end" class="form-control @error('date_end') is-invalid @enderror" value="{{ old('date_end',  $transaction->date_end->format('Y-m-d')) }}">
