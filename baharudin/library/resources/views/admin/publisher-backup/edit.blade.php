            ...
            <div class="card card-primary">
              	...
              	<form action="{{ url('publishers/'.$publisher->id) }}" method="post">
	                ...
	                <div class="card-body">
                      ...
                      <input type="text" name="phone_number" class="form-control" placeholder="Enter phone number" value="{{ $publisher->phone_number }}">
                      <label>Address</label>
                      <input type="text" name="address" class="form-control" placeholder="Enter address" value="{{ $publisher->address }}">
		                </div>
		            </div>
	                <!-- /.card-body -->
